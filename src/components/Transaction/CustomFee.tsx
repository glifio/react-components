...
import { Box, Text, Input, ADDRESS_PROPTYPE, FILECOIN_NUMBER_PROPTYPE } from '@glif/react-components'
...
CustomizeFee.propTypes = {
  ...
  gasInfo: PropTypes.shape({
    ...
    gasPremium: FILECOIN_NUMBER_PROPTYPE,
    gasFeeCap: FILECOIN_NUMBER_PROPTYPE,
    gasLimit: FILECOIN_NUMBER_PROPTYPE
  }),
  setFrozen: PropTypes.func.isRequired,
  feeMustBeLessThanThisAmount: FILECOIN_NUMBER_PROPTYPE,
  gasEstimateMaxFee: PropTypes.func.isRequired,
  gasEstimateMessageGas: PropTypes.func.isRequired,
  wallet: PropTypes.shape({
    address: ADDRESS_PROPTYPE,
    balance: FILECOIN_NUMBER_PROPTYPE,
